...
def oiio_out():
    ...
    oiio_out_.parent.mkdir(parents=True, exist_ok=True)
    yield oiio_out_
...
def test_create_buf_from_raw() -> None:
    ...


@pytest.mark.skip("Not Implemented")
def test__update_raw_spec() -> None:
    ...


@pytest.mark.skip("Not Implemented")
def test__get_overlay_text_buf() -> None:
    ...


@pytest.mark.skip("Not Implemented")
def test__get_overlay_handle_buf() -> None:
    ...


@pytest.mark.skip("Not Implemented")
def test_png_from_raw() -> None:
    ...


@pytest.mark.skip("Not Implemented")
def test_exr_from_raw_with_custom_metadata() -> None:
    ...
...
def test_create_text_overlay(
    ...
    from OpenStudioLandscapes.DagsterCodeLocation.ShotProcessor.api import create_text_overlay, get_frame_number

    raw_in_ = raw_in / "sh030_001.1200.exr"
    exr_out = oiio_out / "out" / "oiio_overlay_text"
