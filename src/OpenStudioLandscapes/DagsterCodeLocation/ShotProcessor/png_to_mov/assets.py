...
GROUP_OIIO_PROCESSOR_PNG_TO_MOV = "OpenStudioLandscapes_DagsterCodeLocation_JobProcessor_OIIO_Processor_png_to_mov"
# KEY_CONSTANTS_DEFAULT = [GROUP_CONSTANTS_DEFAULT, "Constants"]
KEY_OIIO_PROCESSOR_PNG_TO_MOV = [GROUP_OIIO_PROCESSOR_PNG_TO_MOV]

ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV = {
    "group_name": GROUP_OIIO_PROCESSOR_PNG_TO_MOV,
    "key_prefix": KEY_OIIO_PROCESSOR_PNG_TO_MOV,
}
...
@multi_asset(
    ...
    ins={
        ...
        "Deadline_OutputDirectory": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "Deadline_OutputDirectory"]),
        ),
        "Deadline_OutputFilename": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "Deadline_OutputFilename"]),
        ),
    }
)
def job_info(
...
@multi_asset(
    ...
    ins={
        ...
        # ),
        "cmd": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "cmd"])
        ),
    }
)
def plugin_info(
    ...
    **ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV,
    ins={
        ...
        "job_info_model": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "job_info_model"]),
        ),
        "plugin_info_model": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "plugin_info_model"]),
        ),
        # "job_id_raw": AssetIn(
        #     AssetKey([*ASSET_HEADER_JOB_PROCESSOR_DEADLINE["key_prefix"], "job_id_raw"]),
        # ),
...
@multi_asset(
    ...
    ins={
        ...
        "payload_request": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_PNG_TO_MOV["key_prefix"], "payload_request"]),
        ),
        "job_model": AssetIn(
            AssetKey([*ASSET_HEADER_JOB_PROCESSOR_READER["key_prefix"], "read_job_yaml"])
        ),
