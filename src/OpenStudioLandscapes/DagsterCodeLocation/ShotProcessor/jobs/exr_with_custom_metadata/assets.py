...
GROUP_OIIO_PROCESSOR_EXR_WITH_CUSTOM_METADATA = "OpenStudioLandscapes_DagsterCodeLocation_JobProcessor_OIIO_Processor_exr_with_custom_metadata"
...
def exr_with_custom_metadata(
    ...
    output_dir: pathlib.Path = render_output_directory.joinpath(
        ...
        CONFIG.OIIO_EXR_WITH_CUSTOM_METADATA,
    )
...
def job_info_exr_with_custom_metadata(
        context: AssetExecutionContext,
        batch_name: str,
        job_title_str: str,
        render_output_directory: pathlib.Path,
...
def plugin_info_exr_with_custom_metadata(
        context: AssetExecutionContext,
        render_output_directory: pathlib.Path,
...
def submit_request_exr_with_custom_metadata(
        context: AssetExecutionContext,
        CONFIG: DefaultConstants,
