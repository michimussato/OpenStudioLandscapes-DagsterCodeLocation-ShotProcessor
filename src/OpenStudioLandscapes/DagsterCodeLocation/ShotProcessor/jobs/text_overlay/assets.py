...
GROUP_OIIO_PROCESSOR_TEXT_OVERLAY = "OpenStudioLandscapes_DagsterCodeLocation_JobProcessor_OIIO_Processor_text_overlay"
# KEY_CONSTANTS_DEFAULT = [GROUP_CONSTANTS_DEFAULT, "Constants"]
KEY_OIIO_PROCESSOR_TEXT_OVERLAY = [GROUP_OIIO_PROCESSOR_TEXT_OVERLAY]

ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY = {
    "group_name": GROUP_OIIO_PROCESSOR_TEXT_OVERLAY,
    "key_prefix": KEY_OIIO_PROCESSOR_TEXT_OVERLAY,
}
...
@multi_asset(
    ...
    ins={
        ...
        "Deadline_OutputDirectory": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY["key_prefix"], "Deadline_OutputDirectory"]),
        ),
...
@multi_asset(
    ...
    ins={
        ...
        # ),
        "cmd": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY["key_prefix"], "cmd"])
        ),
    }
)
    ...
    **ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY,
    ins={
        ...
        "job_info_model": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY["key_prefix"], "job_info_model"]),
        ),
        "plugin_info_model": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY["key_prefix"], "plugin_info_model"]),
        ),
        # "job_id_raw": AssetIn(
        #     AssetKey([*ASSET_HEADER_JOB_PROCESSOR_DEADLINE["key_prefix"], "job_id_raw"]),
        # ),
...
@multi_asset(
    ...
    ins={
        ...
        "payload_request": AssetIn(
            AssetKey([*ASSET_HEADER_OIIO_PROCESSOR_TEXT_OVERLAY["key_prefix"], "payload_request"]),
        ),
        "job_model": AssetIn(
            AssetKey([*ASSET_HEADER_JOB_PROCESSOR_READER["key_prefix"], "read_job_yaml"])
        ),
...
def submit_request_text_overlay(
        context: AssetExecutionContext,
        CONFIG: DefaultConstants,
