...
```
$ shot-processor --help
usage: shot-processor [-h] [-v] [-vv] --kitsu-task-json KITSU_TASK_JSON --oiio-config-yaml OIIO_CONFIG_YAML --version VERSION --frame-number FRAME_NUMBER --exr-image EXR_IMAGE --output-dir OUTPUT_DIR
                      {create-text-overlay,create-handle-overlay,exr-with-custom-metadata} ...
